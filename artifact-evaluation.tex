...
The evaluation artifact is available at {\color{blue}\url{https://github.com/ogx-ai/ogx}} under the MIT license. It contains:
\begin{itemize}
  \item 9 Python scripts and a master orchestration script (\texttt{run\_all.sh})
  \item 5 OGX server configurations (one per 2$\times$2 matrix cell + GPU)
