...
\begin{itemize}
  ...
  \item \textbf{Prompts API:} Manages prompt templates and configurations, though prompt creation currently requires access to the administrative interface rather than being fully programmable via API.
\end{itemize}
